...
Route::post('ajax/dislike', 'AjaxController@dislike');
Route::post('ajax/imageview', 'AjaxController@imageview');
...
Route::group(['middleware' => 'role'], function() {
	...
	// Ads
	Route::get('panel/admin/ads','AdminController@ads');
	Route::get('panel/admin/ads/add','AdminController@addAds');
	Route::post('panel/admin/ads/add','AdminController@stroredAds');
	Route::get('panel/admin/ads/edit/{id}','AdminController@editAds')->where(array( 'id' => '[0-9]+'));
	Route::post('panel/admin/ads/update','AdminController@updateAds');
	Route::get('panel/admin/ads/delete/{id}','AdminController@deleteAds')->where(array( 'id' => '[0-9]+'));
