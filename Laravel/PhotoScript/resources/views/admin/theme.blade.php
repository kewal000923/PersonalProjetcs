                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->logo)}}" style="width:150px">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->image_header)}}" style="width:200px">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->image_bottom)}}" style="width:200px">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->watermark)}}" style="width:300px; background-color: #000;">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->header_colors)}}" style="width:200px;">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('/img', $settings->header_cameras)}}" style="width:200px;">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('img-category', $settings->img_category)}}" style="width:250px;">
                        </div>
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <div class="btn-block margin-bottom-10">
                          <img src="{{url('img', $settings->img_collection)}}" style="width:250px;">
                        </div>
