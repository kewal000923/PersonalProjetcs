    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <!-- Links -->
         <li @if(Request::is('panel/admin/bulk-upload')) class="active" @endif>
           <a href="{{ url('panel/admin/bulk-upload') }}"><i class="fa fa-cloud-upload"></i> <span>{{ trans('bulk_upload.bulk_upload') }}</span></a>
         </li><!-- ./Links -->
        ...
        <!-- Links -->
        <li @if(Request::is('panel/admin/ads')) class="active" @endif>
